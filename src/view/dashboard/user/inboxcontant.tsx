...
const InboxsContant: React.FC<any> = (props: Cprops | any) => {
  const { contact, dispatch, getwholeListdata, showInbox, setShowInbox } = props;
          ...
          <>
            ...
            {contact?.related?.map((res: any, index: any) => (
              <>
                <div>
                  <div
                    className="mt-6 flex flex-wrap cursor-pointer"
                  ...
                  >
                    ...
                    <div className="pl-4 font-bold">
                      {contact?.senderName === res?.receiverName
                        ? "You"
                        : res?.senderName}
                    </div>
                    <div className="pl-4 ">
                ...
                {showString === index &&
                  ...
                  Number(showContact) === Number(index) && (
                    <>
                      ...
                      <div className="flex">
                        <label className="custom-file-upload cursor-pointer flex items-center">
                          <input
                            type="file"
                            className="hidden"
                            ref={hiddenFileInput}
